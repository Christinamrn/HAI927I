...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.bouton_chromatique.setGeometry(QRect(850, 20, 75, 24))
        self.bouton_afficher = QPushButton(self.centralwidget)
        self.bouton_afficher.setObjectName(u"bouton_afficher")
        self.bouton_afficher.setGeometry(QRect(840, 150, 75, 24))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bouton_afficher.setText(QCoreApplication.translate("MainWindow", u"PushButton", None))
    # retranslateUi
