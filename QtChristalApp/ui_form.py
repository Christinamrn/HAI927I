...
"background-color: #d46464;")
        ...
        self.bouton_MPRNet.setGeometry(QRect(260, 100, 75, 24))
...
"background-color: #d46464;")
        ...
        self.horizontalLayoutWidget_3 = QWidget(self.SNR)
        self.horizontalLayoutWidget_3.setObjectName(u"horizontalLayoutWidget_3")
        self.horizontalLayoutWidget_3.setGeometry(QRect(60, 40, 161, 31))
        self.horizontalLayout_3 = QHBoxLayout(self.horizontalLayoutWidget_3)
        self.horizontalLayout_3.setObjectName(u"horizontalLayout_3")
        self.horizontalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.label_SNR = QLabel(self.horizontalLayoutWidget_3)
        self.label_SNR.setObjectName(u"label_SNR")
        self.label_SNR.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.horizontalLayout_3.addWidget(self.label_SNR)

        self.horizontalSpacer_3 = QSpacerItem(15, 5, QSizePolicy.Fixed, QSizePolicy.Minimum)
        ...
        self.tabWidget_Mesure.addTab(self.SNR, "")
        self.SSIM = QWidget()
        ...
        self.verticalLayoutWidget = QWidget(self.SSIM)
        self.verticalLayoutWidget.setObjectName(u"verticalLayoutWidget")
        self.verticalLayoutWidget.setGeometry(QRect(9, 20, 271, 41))
        self.verticalLayout = QVBoxLayout(self.verticalLayoutWidget)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.label_SSIM = QLabel(self.verticalLayoutWidget)
        self.label_SSIM.setObjectName(u"label_SSIM")
        self.label_SSIM.setAlignment(Qt.AlignCenter)

        self.verticalLayout.addWidget(self.label_SSIM)

        self.tabWidget_Mesure.addTab(self.SSIM, "")
        self.RMSE = QWidget()
        self.RMSE.setObjectName(u"RMSE")
        self.verticalLayoutWidget_2 = QWidget(self.RMSE)
        self.verticalLayoutWidget_2.setObjectName(u"verticalLayoutWidget_2")
        self.verticalLayoutWidget_2.setGeometry(QRect(10, 20, 271, 41))
        self.verticalLayout_2 = QVBoxLayout(self.verticalLayoutWidget_2)
        self.verticalLayout_2.setObjectName(u"verticalLayout_2")
        self.verticalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.label_RMSE = QLabel(self.verticalLayoutWidget_2)
        self.label_RMSE.setObjectName(u"label_RMSE")
        self.label_RMSE.setAlignment(Qt.AlignCenter)

        self.verticalLayout_2.addWidget(self.label_RMSE)

        self.tabWidget_Mesure.addTab(self.RMSE, "")
        self.BRISQUE = QWidget()
        self.BRISQUE.setObjectName(u"BRISQUE")
        self.verticalLayoutWidget_3 = QWidget(self.BRISQUE)
        self.verticalLayoutWidget_3.setObjectName(u"verticalLayoutWidget_3")
        self.verticalLayoutWidget_3.setGeometry(QRect(10, 20, 271, 41))
        self.verticalLayout_3 = QVBoxLayout(self.verticalLayoutWidget_3)
        self.verticalLayout_3.setObjectName(u"verticalLayout_3")
        self.verticalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.label_BRISQUE = QLabel(self.verticalLayoutWidget_3)
        self.label_BRISQUE.setObjectName(u"label_BRISQUE")
        self.label_BRISQUE.setAlignment(Qt.AlignCenter)

        self.verticalLayout_3.addWidget(self.label_BRISQUE)

        self.tabWidget_Mesure.addTab(self.BRISQUE, "")
        ...
        self.tabWidget_Mesure.setCurrentIndex(4)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radio_papier.setText(QCoreApplication.translate("MainWindow", u"Filtrage EPDFP*", None))
        self.radio_laplacien.setText(QCoreApplication.translate("MainWindow", u"Filtrage Laplacien", None))
        self.label_papier.setText(QCoreApplication.translate("MainWindow", u"*Efficient Poisson Denoising for Photography", None))
        ...
        self.tabWidget_Mesure.setTabText(self.tabWidget_Mesure.indexOf(self.SNR), QCoreApplication.translate("MainWindow", u"SNR", None))
        ...
        self.tabWidget_Mesure.setTabText(self.tabWidget_Mesure.indexOf(self.RMSE), QCoreApplication.translate("MainWindow", u"RMSE", None))
        self.label_BRISQUE.setText("")
        self.tabWidget_Mesure.setTabText(self.tabWidget_Mesure.indexOf(self.BRISQUE), QCoreApplication.translate("MainWindow", u"BRISQUE", None))
