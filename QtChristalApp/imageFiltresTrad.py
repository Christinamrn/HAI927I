...
#A la fin de chaque filtrage, on modifie la variable ImageIsFiltered pour dire qu'elle a été filtrée
...
def filtre_bilateral(image_path, diameter, var_color, var_space, MainWindow):
    ...
    MainWindow.ImageIsFiltered = True
    print(MainWindow.ImageIsFiltered)
